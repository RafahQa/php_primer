...
<body>
    ...
    <ul class="nav nav-pills">
        ...
        <li class="nav-item"><a class="nav-link" href="string.php">Simple String Manipulation</a></li>
        <li class="nav-item"><a class="nav-link" href="datetime.php">Simple Date and Time Manipulation</a></li>
